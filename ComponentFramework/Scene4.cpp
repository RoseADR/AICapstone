...
Scene4::Scene4() :drawNormals(false), drawOverlay(false) {
...
bool Scene4::OnCreate() {
	...
	Vec3 dir = Vec3(-1.0f, -180.0f, -1.0f); // Soft diagonal light
	Vec4 color = Vec4(5.4f, 5.4f, 5.45f, 1.0f); // Softer white light
	...
	backGround->AddComponent<MaterialComponent>(assetManager->GetComponent<MaterialComponent>("VicBot"));
	AddActor(backGround);
